...
use common\modules\cms\models\LessonCategorySearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * LessonCategoryController implements the CRUD actions for LessonCategory model.
 */
class LessonCategoryController extends Controller
{
    ...
    {
        $searchModel = new LessonCategorySearch();
